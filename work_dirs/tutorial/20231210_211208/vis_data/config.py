...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/workspaces/ECE661GroupProject_TransferLearning/splits/val.txt',
        data_prefix=dict(
            img_path='image_png_256', seg_map_path='fluid_png_256'),
        data_root='/workspaces/ECE661GroupProject_TransferLearning/data',
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/workspaces/ECE661GroupProject_TransferLearning/splits/train.txt',
        data_prefix=dict(
            img_path='image_png_256', seg_map_path='fluid_png_256'),
        data_root='/workspaces/ECE661GroupProject_TransferLearning/data',
        pipeline=[
